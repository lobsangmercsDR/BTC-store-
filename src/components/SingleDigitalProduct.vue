      ...
      <div class="bg-white rounded-lg shadow-md p-4 md:p-8 transition-colors duration-500 hover:bg-blue-50 mx-auto">
        <div v-if="product" class="flex flex-col md:flex-row">
          ...
          <div class="w-full md:w-1/2 md:pl-8">
            ...
            <div class="flex items-center mb-4">
              <span class="text-gray-600 text-lg mr-2">Likes:</span>
              ...
              <button @click="incrementLikes" class="text-green-500 hover:text-green-600 focus:outline-none">
                <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  ...
                  <path d="M15.707 9.293l-4 4a.997.997 0 0 1-1.414 0l-2-2a.999.999 0 1 1 1.414-1.414L11 10.586l3.293-3.293a.999.999 0 1 1 1.414 1.414z"/>
                </svg>
              </button>
            </div>
            <div class="flex items-center mb-4">
              <span class="text-gray-600 text-lg mr-2">Dislikes:</span>
            ...
            <div class="flex mb-4 space-x-4 justify-end"> <!-- Aquí se aplica justify-end para alinear los botones a la derecha -->
